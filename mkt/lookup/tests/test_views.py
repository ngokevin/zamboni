...
class TestTransactionSummary(TestCase):
    ...
    def get_side_effect(self, *args, **kwargs):
        ...
        elif args[0] == 'related_tx_uri':
            return {'uuid': self.related_tx_uuid}
...
class TestTransactionRefund(TestCase):
    ...
    @mock.patch.object(client, 'lookup_transaction')
    def test_mark_transaction_refund(self, lookup_transaction):
        lookup_transaction.return_value = {'resource_pk': 1}
